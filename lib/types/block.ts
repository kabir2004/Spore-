/**
 * @fileoverview Block type definitions and property shapes for the Spore editor.
 * All content (pages, text, lists, media, etc.) is represented as IBlock; type is discriminated by `type`.
 */
