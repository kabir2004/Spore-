...
/**
 * Layout shell for authenticated workspace routes: sidebar, top bar, command palette,
 * workspace context, and real-time block sync. Renders children (page content) inside
 * the main content area with page transitions.
 */
